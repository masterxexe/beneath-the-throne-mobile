...
export const PLAYER_POSE_ASSETS = {
  idle:{base:POSE+"player-idle-v28.png"},
  "walk-left":{base:POSE+"player-walk-left-v64.png"},
  "walk-left-a":{base:POSE+"player-walk-left-v64.png"},
  "walk-left-b":{base:POSE+"player-walk-left-b-v65.png"},
  "walk-left-c":{base:POSE+"player-walk-left-c-v69.png"},
  "walk-left-d":{base:POSE+"player-walk-left-d-v69.png"},
  "walk-right":{base:POSE+"player-walk-right-v64.png"},
  "walk-right-a":{base:POSE+"player-walk-right-v64.png"},
  "walk-right-b":{base:POSE+"player-walk-right-b-v65.png"},
  "walk-right-c":{base:POSE+"player-walk-right-c-v69.png"},
  "walk-right-d":{base:POSE+"player-walk-right-d-v69.png"},
  "walk-forward":{base:POSE+"player-walk-forward-v64.png"},
  "walk-forward-a":{base:POSE+"player-walk-forward-v64.png"},
  "walk-forward-b":{base:POSE+"player-walk-forward-b-v65.png"},
  "walk-forward-c":{base:POSE+"player-walk-forward-c-v69.png"},
  "walk-forward-d":{base:POSE+"player-walk-forward-d-v69.png"},
  "walk-away":{base:POSE+"player-walk-away-v64.png"},
  "walk-away-a":{base:POSE+"player-walk-away-v64.png"},
  "walk-away-b":{base:POSE+"player-walk-away-b-v65.png"},
  "walk-away-c":{base:POSE+"player-walk-away-c-v69.png"},
  "walk-away-d":{base:POSE+"player-walk-away-d-v69.png"},
  "walk-up":{base:POSE+"player-walk-away-v64.png"},
  "walk-up-a":{base:POSE+"player-walk-away-v64.png"},
  "walk-up-b":{base:POSE+"player-walk-away-b-v65.png"},
  "walk-up-c":{base:POSE+"player-walk-away-c-v69.png"},
  "walk-up-d":{base:POSE+"player-walk-away-d-v69.png"},
  "walk-down":{base:POSE+"player-walk-forward-v64.png"},
  "walk-down-a":{base:POSE+"player-walk-forward-v64.png"},
  "walk-down-b":{base:POSE+"player-walk-forward-b-v65.png"},
  "walk-down-c":{base:POSE+"player-walk-forward-c-v69.png"},
  "walk-down-d":{base:POSE+"player-walk-forward-d-v69.png"},
...
export const PLAYER_COMPOSITE_ASSETS = {
  idle:{
    scout_hood:P+"composites/scout_hood/idle-v38.png",
    ash_axe:P+"composites/ash_axe/idle-v38.png",
    leather_armor:P+"composites/leather_armor/idle-v38.png",
    leather_armor_scout_hood:P+"composites/leather_armor_scout_hood/idle-v38.png",
    starter_leather_hood_axe:P+"composites/starter_leather_hood_axe/idle-v38.png",
    hunter_ranger:P+"composites/hunter_ranger/idle-v39.png",
    chainmail_sword:P+"composites/chainmail_sword/idle-v39.png",
