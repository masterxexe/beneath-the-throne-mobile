...
`btt-web-playtest/redesign.css` requests these fonts from Google Fonts at runtime. Font binaries are not committed to this repository or copied into the hackathon deployment artifact.
...
No tracked image or audio file contains an embedded third-party license notice. See [ASSET_PROVENANCE.md](ASSET_PROVENANCE.md) for the provenance limits identified by the repository audit.
